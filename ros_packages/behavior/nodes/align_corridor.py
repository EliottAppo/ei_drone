...
class AlignCorridor(Behavior):
    def __init__(self):
        ...
        self.alpha = rospy.get_param(
            "/logical_behaviors/AlignCorridor/alpha", 0.95)
        self.dist_threshold = rospy.get_param(
            "/logical_behaviors/AlignCorridor/dist_threshold", 10)
        self.angular_z_vel = rospy.get_param(
            "/logical_behaviors/AlignCorridor/angular_z_vel", 0.1)
            ...
            if self.get_status():
                if self.vp_exists:
                    ...
                    if coord_center_dist > self.dist_threshold:
                        ...
                        # Vanishing point too much on theright, rotate in the clockwise sense
